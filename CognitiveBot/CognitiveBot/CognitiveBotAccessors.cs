...
namespace CognitiveBot
{
    ...
    /// </summary>
    public class CognitiveBotAccessors
    {
        /// <summary>
        ...
        public CognitiveBotAccessors(ConversationState conversationState)
        {
        ...
        public static string CounterStateName { get; } = $"{nameof(CognitiveBotAccessors)}.CounterState";
